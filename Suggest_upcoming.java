...
public class Suggest_upcoming extends JFrame implements ActionListener {
	...
	Suggest_upcoming(){
        ...
        JLabel l2 = new JLabel("Select event");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == b) {
			if (t1.getText().equals("")) {
                ...
                try{
                    String select_event = t1.getText();
                    String des = t2.getText();
                    Conn c = new Conn();
                    String query = "insert into Suggest_upcoming values('"+select_event+"','"+des+"')";
